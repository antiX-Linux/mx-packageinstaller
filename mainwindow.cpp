...
void MainWindow::setup()
{
    ...
    version = getVersion("packageinstaller");
    this->setWindowTitle(tr("Package Installer"));
...
void MainWindow::loadPmFiles()
{
    ...
    QDir dir("/usr/share/packageinstaller-pkglist");
...
void MainWindow::displayWarning()
{
    ...
    QMessageBox msgBox(QMessageBox::Warning,
                       ...
                       tr("You are about to use Debian Backports, which contains packages taken from the next "\
                          ...
                          "They cannot be tested as extensively as in the stable releases of Debian and antiX Linux, "\
...
void MainWindow::installPopularApps()
{
    ...
    if (QMessageBox::information(this, tr("Done"),
                                 tr("Process finished.<p><b>Do you want to exit Package Installer?</b>"),
                                 tr("Yes"), tr("No")) == 0){
        qApp->exit(0);
    }
    refreshPopularApps();
...
void MainWindow::on_buttonAbout_clicked()
{
    ...
    QMessageBox msgBox(QMessageBox::NoIcon,
                       tr("About Package Installer"), "<p align=\"center\"><b><h2>" +
                       tr("Package Installer") + "</h2></b></p><p align=\"center\">" + tr("Version: ") + version + "</p><p align=\"center\"><h3>" +
                       tr("Package Installer for antiX Linux") +
